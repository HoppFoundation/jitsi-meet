...
- (NSString *)socketFilePath {
    ...
    NSString *appGroupIdentifier = @"group.de.hopp-foundation.screenrecording";
...
- (void)openConnection {
  dispatch_queue_t queue = dispatch_queue_create("de.hopp-foundation.klassenzimmer.broadcast.connectTimer", 0);
